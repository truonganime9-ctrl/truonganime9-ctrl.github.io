...
<style>
    ...
    #container {
        ...
        align-items: center;
        z-index: 1; /* Đảm bảo nội dung chính nằm dưới ảnh góc */
    }
    ...
    #messages {
        ...
        z-index: 5; /* Đảm bảo lời chúc nằm trên nền mờ nhưng dưới ảnh góc */
    }
    .line {
        opacity: 0;
        margin: 10px 0;
    ...
    #extra-link {
        ...
        z-index: 6; /* Đảm bảo nút nằm trên lời chúc */
    }
    #extra-link:hover {
        background: #e60073;
    }
    ...
    .falling {
        ...
        user-select: none;
        z-index: 0; /* Đảm bảo hiệu ứng rơi nằm dưới cùng */
    }
    @keyframes fall {
        to {
    ...
    .corner-image-container {
      position: fixed;
      z-index: 1000; /* Đảm bảo ảnh luôn nằm trên cùng */
      width: 150px;
      height: 150px;
      overflow: hidden;
      border-radius: 10px;
